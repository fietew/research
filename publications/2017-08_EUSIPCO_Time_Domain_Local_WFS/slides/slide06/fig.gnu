...
set style line 102 lc rgb 'black' lw 4 ps 1.5 pt 2
...
@pos_top_left
# plotting
filename = 'P_lwfs_f1000'
plot filename.'.dat' binary matrix with image, \
  filename.'_rM.txt' with lines ls 101, \
  'xc.txt' with points ls 102,\
