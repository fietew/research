...
# labels
load 'labels.cfg'
set label 1 at graph 0.15, 1.17 left front
set label 2 at graph 0.15, 1.07 left front
set label 3 center front tc rgb '#808080'
set label 5 at graph 0.0, 1.17 left front '\stepcounter{tmpcounter}(\alph{tmpcounter})'
# variables
sx = 0.17
sy = 0.40
oriy1 = 0.515
...
#### plot 1 ####
# labels
set label 1 'omnidirectional'
set label 2 'uniform sampling'
# positioning
set size sx, sy
...
unset colorbox
# variables
filename = 'ps_linear_as90_none'
# plotting
load 'plotP.gnu'

#### plot 2 ####
# labels
set label 1 'directive'
# positioning
set size sx, sy
set origin orix2, oriy1
@pos_top
# variables
filename = 'ps_linear_as30_none'
# plotting
load 'plotP.gnu'
...
# labels
set label 1 'omnidirectional'
set label 2 'optimised for omni.'
# positioning
set size sx, sy
set origin orix3, oriy1
@pos_top
# variables
filename = 'ps_linear_as90_both_ao90_xc-0.50_yc0.00_Rc0.25'
# plotting
load 'plotP.gnu'
...
# variables
filename = 'ps_linear_as30_both_ao90_xc-0.50_yc0.00_Rc0.25'
# plotting
load 'plotP.gnu'

#### plot 5 ####
# labels
set label 2 'optimised for directive'
# positioning
set size sx, sy
...
set colorbox @colorbar_east
# variables
filename = 'ps_linear_as30_both_ao30_xc-0.50_yc0.00_Rc0.25'
# plotting
load 'plotP.gnu'
