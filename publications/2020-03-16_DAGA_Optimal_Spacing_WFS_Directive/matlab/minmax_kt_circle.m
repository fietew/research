function [kGtmin, kGtmax] = minmax_kt_circle(x0, xc, Rc, kGbound)
%
...
if nargin == 4
  kGtmin = max(kGtmin, -kGbound);
  kGtmax = min(kGtmax, +kGbound);
  kGtmin(kGtmin > kGtmax) = NaN;
  kGtmax(kGtmin > kGtmax) = NaN;
end
