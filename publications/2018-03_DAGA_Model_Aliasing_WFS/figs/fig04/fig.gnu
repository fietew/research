...
set style line 211 lc rgb '#000000' lt 1 lw 3 pt 7 ps 1  # array_active
# labels
load 'labels.cfg'
set label 1 at graph 0.0, 1.05 left front
set label 2 at graph 1.07, 1.05 center front tc rgb '#808080'
# variables
sx = 0.17
sy = 0.40
oriy1 = 0.525
...
#### plot 2 ####
# labels
set label 1 '\ft $\Delta_x \approx 11,8$ cm'
unset label 3
# positioning
set size sx, sy
