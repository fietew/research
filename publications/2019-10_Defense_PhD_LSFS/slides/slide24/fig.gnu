...
set arrow 2 from first 0,-1.1 rto first -0.5,0 lw 3 lc rgb 'gray' heads size 0.1,90
...
set label 2 at first -0.5, -1.3 '$50\,\mathrm{cm}$'
set label 3 at first -0.35, 2.0 '$2.5\,\mathrm{m}$' right

################################################################################

plot 'listener.txt' using 1:2 w p pt 2 ps 1 lc rgb 'black',\
  'listener.txt' using 1:2:(sprintf('$%d$',$0)) with labels tc rgb 'black' left offset 0.0,-0.6 ,\
