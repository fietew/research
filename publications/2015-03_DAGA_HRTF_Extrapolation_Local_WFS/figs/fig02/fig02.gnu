...
################################################################################
set t epslatex size 18cm,6cm color colortext
set output 'tmp.tex';
...
set colorbox vert user origin graph 1.05, 0.0 size graph 0.05,1.0
set lmargin 0
set rmargin 6
...
!sed 's|includegraphics{tmp}|includegraphics{fig02}|' < tmp.tex > fig02.tex
!epstopdf tmp.eps --outfile='fig02.pdf'
