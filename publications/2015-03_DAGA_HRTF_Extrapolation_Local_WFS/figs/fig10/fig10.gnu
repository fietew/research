...
set lmargin 3
set rmargin 0
set label 1 '\footnotesize Referenz' at 1.05,1.15 right front
plot 'sound_field_ref.dat' binary matrix with image
set border 1
set format y ''
set ytics scale 0
unset ylabel
...
!sed 's|includegraphics{tmp}|includegraphics{fig10}|' < tmp.tex > fig10.tex
!epstopdf tmp.eps --outfile='fig10.pdf'
