...
\begin{scope}
  \clip plot [anchor=south west, scale=7.0] file 
  {../slides/slide01/fig.csv};
  \node[anchor=south west, inner sep=0] at (0,0)  
    {\includegraphics[scale=0.8]{../slides/slide01/soundfield}};
\end{scope}
...
\draw[draw=black!60,%
  ...
  plot[scale=7.0] file {../slides/slide01/fig.csv} -- cycle;

\node[below of=d0tmp] (dO) {$\sfboundary$};
\draw[-latex'] (dO) to[out=45,in=-45] (d0tmp);

\node[above of=Otmp] {$\sfset$};
