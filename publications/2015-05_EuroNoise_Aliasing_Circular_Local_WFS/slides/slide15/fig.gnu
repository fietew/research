...
set label 3 @label_multititle '\footnotesize $\accentset{\circ} D_0^{\mathrm S}(\nu, \omega)$ for plane wave with $\alpha_{\mathrm{pw}} = 90^\circ$ using $N_0 = 40$ loudspeakers'
...
plot 'spectrum_Dlwfs_sampled.dat' binary matrix with image
...
unset label 3
plot 'spectrum_Dwfs_sampled.dat' binary matrix with image
