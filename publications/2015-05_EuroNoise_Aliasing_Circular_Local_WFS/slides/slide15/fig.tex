...
\begingroup
  ...
  \begin{picture}(5102.00,2266.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      \csname LTb\endcsname%
      \put(2220,2257){\makebox(0,0)[r]{\strut{}\footnotesize local WFS}}%
      \put(2551,2831){\makebox(0,0){\strut{}\footnotesize $\accentset{\circ} D_0^{\mathrm S}(\nu, \omega)$ for plane wave with $\alpha_{\mathrm{pw}} = 90^\circ$ using $N_0 = 40$ loudspeakers}}%
    }%
    \gplgaddtomacro\gplbacktext{%
      \colorrgb{0.50,0.50,0.50}%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \csname LTb\endcsname%
      \put(4771,2257){\makebox(0,0)[r]{\strut{}\footnotesize WFS}}%
    }%
    \gplbacktext
