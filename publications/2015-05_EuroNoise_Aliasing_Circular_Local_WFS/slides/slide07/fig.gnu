...
set label 2 @label_multititle \
  '\footnotesize $\accentset{\circ} D_0(\nu, \omega)$ for plane wave with $\alpha_{\mathrm{pw}} = 90^\circ$'
...
plot 'spectrum_D0_R1.5.dat' binary matrix with image
...
set label 1 '\footnotesize $R_0 = 3.0$m'
plot 'spectrum_D0_R3.0.dat' binary matrix with image
