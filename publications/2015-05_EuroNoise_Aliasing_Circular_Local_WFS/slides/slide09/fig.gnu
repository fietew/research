...
# plot 1
set label 1 '\footnotesize $N_0 = 40$
set label 2 '\footnotesize $\accentset{\circ} D_0^{\mathrm S}(\nu, \omega)$'
plot 'spectrum_D0_sampled.dat' binary matrix with image

#plot 2
set format y '' # remove labels of tics
unset ylabel # remove label of y-axis
set colorbox @colorbar_east
set label 1 '\footnotesize $r = 1.0$m'
set label 2 '\footnotesize $\accentset{\circ} G_0(\nu, r, \omega)$'
