% circular harmonics spectrum of a sampled WFS driving function for a
% virtual plane wave and spectra of the 2D Green's Function
...
% gnuplot
gp_save_matrix('spectrum_D0_sampled.dat', ...
  nuvec,fvec,20*log(abs(D0sampled)./max(abs(D0sampled(:)))));
