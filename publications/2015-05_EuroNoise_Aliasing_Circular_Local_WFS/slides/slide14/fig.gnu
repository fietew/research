...
set label 3 @label_multititle '\footnotesize $R_l = 1.0$m'
...
# plot 1
set label 1 '\footnotesize $N_l = 50$'
set label 2 '\footnotesize $\accentset{\circ} D_l^{\mathrm S}(\nu, \omega)$'
plot 'spectrum_Dlsampled.dat' binary matrix with image

#plot 2
set format y '' # remove labels of tics
unset ylabel # remove label of y-axis
set colorbox @colorbar_east
set label 1 '\footnotesize $R_0 = 1.5$m'
set label 2 '\footnotesize $\accentset{\circ} D_{fs}(\nu, \omega)$'
plot 'spectrum_Dfs.dat' binary matrix with image
