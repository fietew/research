...
# labels
load 'labels.cfg'
set label 1 @label_northeast '\footnotesize $r = 1.0$m'
...
# plot 1
set label 2 '\footnotesize $\accentset{\circ} P_0(\nu, r, \omega)$'
plot 'spectrum_P.dat' binary matrix with image

#plot 2
set format y '' # remove labels of tics
unset ylabel # remove label of y-axis
set colorbox @colorbar_east
set label 2 '\footnotesize $\accentset{\circ} P_0^{\mathrm S}(\nu, r, \omega)$'
plot 'spectrum_Psampled.dat' binary matrix with image
