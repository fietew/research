...
################################################################################
set t epslatex size 15.9cm,8cm color colortext header "\\newcommand{\\ft}[0]{\\footnotesize}"
set output 'tmp.tex';
...
set label 1 '\ft 2012'
# title
set title 'arithmetic mean (avr) of signed error'

file = '2012_err_mean.txt'
plot for [ii=1:10] file using 1:4+ii ls 3,\
  file using 1:2:3 w yerrorbars ls 1,\
  file using 1:(-9*f($4)) w p ls 2
...
# title
set title 'standard deviation (std) of signed error'
