...
@pos_bottom_left
# plotting
plot 'P_pw1.dat' binary matrix with image, \
...
@pos_bottom
# plotting
plot 'P_pw2.dat' binary matrix with image, \
  'array.txt' @array_active
...
@pos_bottom
# plotting
plot 'P_ps.dat' binary matrix with image, \
  'array.txt' @array_active
...
@pos_bottom_right
# plotting
plot 'P_fs.dat' binary matrix with image, \
  'array.txt' @array_active
