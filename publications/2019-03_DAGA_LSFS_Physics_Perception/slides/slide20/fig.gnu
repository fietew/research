...
print_error(x) = x < 10 ? sprintf('\\scs $%2.1f^{\\circ}$',x) : sprintf('\\scs $%2.0f^{\\circ}$',x)

print_blur(x) = sprintf('\\scs \\shortstack[l]{blur:\\\\%s}', print_error(x) )
print_loc(x) = sprintf('\\scs \\shortstack[l]{avr:\\\\%s}', print_error(x) )
