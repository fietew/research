...
load 'grid.cfg'
# labels
set label 1 at first  5.5, 1.25 tc ls 8 'NFCHOA'
set label 2 at first  2.0, 1.25 tc ls 2 'WFS'
set label 3 at first 12.5, 1.25 tc ls 4 'LWFS'
set label 4 at first   6.5, 0.4 tc ls 8 rotate by -90 '$\overset{M}{\leftarrow}$'
set label 5 at first   13, 0.4 tc ls 4 rotate by -90 '$\overset{M}{\leftarrow}$'
# margins
set tmargin 0.4
set bmargin 2.25
set lmargin 2
...
# x-axis
set xrange [1:20]
set xlabel offset 0,1.0 'aliasing frequency $\sffS$ / kHz'
set xtics offset 0,0.5
set xtics add (0.2, 20)
set logscale x
# y-axis
set yrange [0.2:15]
set ylabel offset 2,0 'beamforming frequency $\sff^B$ / kHz'
...
# plotting
plot 'wfs.txt' u ($1/1000):($3/1000) w l ls 2 lw 6,\
